...
function run(configuration) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        core_1.setSecret(settings.repositoryPath);
        try {
            ...
            errorState = true;
            console.log('I CAUGHT HERE?!??', errorState);
            core_1.setFailed(error);
        }
        finally {
            console.log(`${errorState ? "Deployment Failed ❌" : "Completed Deployment Successfully! ✅"}`);
        }
    });
}
exports.default = run;
