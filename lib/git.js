    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if ((util_1.isNullOrUndefined(action.accessToken) &&
                ...
                util_1.isNullOrUndefined(action.repositoryPath)) {
            ...
            core_1.setFailed(`There was an error initializing the repository: ${error}`);
        }
        finally {
...
function deploy(action) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield execute_1.execute(`git push --force ${action.repositoryPath} ${temporaryDeploymentBranch}:${action.branch}`, temporaryDeploymentDirectory);
            ...
            core_1.setFailed(`The deploy step encountered an error: ${error}`);
        }
        finally {
