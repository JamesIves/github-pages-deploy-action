...
function init(action) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (util_1.isNullOrUndefined(action.folder)) {
                core_1.setFailed("You must provide the action with a folder to deploy.");
            }
            ...
            yield execute_1.execute(`git remote add origin ${constants_1.repositoryPath}`, action.workspace);
...
function generateBranch(action) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield execute_1.execute(`git push ${constants_1.repositoryPath} ${action.branch}`, action.workspace);
            yield execute_1.execute(`git fetch`, action.workspace);
        }
        catch (error) {
...
function deploy(action) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        /*
          ...
          */
        const branchExists = yield execute_1.execute(`git ls-remote --heads ${constants_1.repositoryPath} ${action.branch} | wc -l`, action.workspace);
        ...
        yield switchToBaseBranch(action);
        yield execute_1.execute(`git fetch ${constants_1.repositoryPath}`, action.workspace);
