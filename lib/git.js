    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (process.env.GIT_CONFIG_COUNT) {
                (0, core_1.info)('Clearing GIT_CONFIG environment variables...');
                ...
                (0, core_1.info)('Cleared GIT_CONFIG environment variables');
            }
            /**
            ...
            try {
                ...
                if (credentialHelperResult.stdout) {
                    (0, core_1.info)(`Found credential helper: ${credentialHelperResult.stdout}`);
                ...
                (0, core_1.info)('No credential helper configured');
            }
