...
function generateBranch(action) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            throw new Error(`There was an error creating the deployment branch: ${error} ❌`);
        }
    });
}
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield execute_1.execute(`git commit -m "${!util_1.isNullOrUndefined(action.commitMessage)
                ...
                : `Deploying to ${action.branch} from ${action.baseBranch}`} ${process.env.GITHUB_SHA ? `- ${process.env.GITHUB_SHA}` : ""} 🚀" --quiet`, temporaryDeploymentDirectory);
