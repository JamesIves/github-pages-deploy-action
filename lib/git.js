    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!util_1.isNullOrUndefined(constants_1.action.deployKey)) {
                ...
                fs_1.appendFile(`${constants_1.ssh}/id_rsa`, constants_1.action.deployKey, () => __awaiter(this, void 0, void 0, function* () {
                    yield execute_1.execute(`ssh -T git@github.com`, constants_1.workspace);
                }));
            }
